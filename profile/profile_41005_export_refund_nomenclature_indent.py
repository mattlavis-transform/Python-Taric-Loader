...
class profile_41005_export_refund_nomenclature_indent(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        export_refund_nomenclature_indents_sid = g.app.get_number_value(omsg, ".//oub:export.refund.nomenclature.indents.sid", True)
        ...
        number_export_refund_nomenclature_indents = g.app.get_number_value(omsg, ".//oub:number.export.refund.nomenclature.indents", True)
        ...
        export_refund_code = g.app.get_value(omsg, ".//oub:export.refund.code", True)
