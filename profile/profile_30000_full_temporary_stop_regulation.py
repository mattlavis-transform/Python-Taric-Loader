...
class profile_30000_full_temporary_stop_regulation(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        full_temporary_stop_regulation_role = g.app.get_value(omsg, ".//oub:full.temporary.stop.regulation.role", True)
        full_temporary_stop_regulation_id = g.app.get_value(omsg, ".//oub:full.temporary.stop.regulation.id", True)
        ...
        effective_enddate = g.app.get_date_value(omsg, ".//oub:effective.enddate", True)
