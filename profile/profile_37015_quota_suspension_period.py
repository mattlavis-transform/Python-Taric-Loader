...
class profile_37015_quota_suspension_period(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        quota_suspension_period_sid = g.app.get_number_value(omsg, ".//oub:quota.suspension.period.sid", True)
        quota_definition_sid = g.app.get_number_value(omsg, ".//oub:quota.definition.sid", True)
        suspension_start_date = g.app.get_date_value(omsg, ".//oub:suspension.start.date", True)
        suspension_end_date = g.app.get_date_value(omsg, ".//oub:suspension.end.date", True)
