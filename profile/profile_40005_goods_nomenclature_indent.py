...
class profile_40005_goods_nomenclature_indent(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        goods_nomenclature_indent_sid = g.app.get_number_value(omsg, ".//oub:goods.nomenclature.indent.sid", True)
        ...
        number_indents = g.app.get_value(omsg, ".//oub:number.indents", True)
