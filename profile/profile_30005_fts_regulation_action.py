...
class profile_30005_fts_regulation_action(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        fts_regulation_role = g.app.get_value(omsg, ".//oub:fts.regulation.role", True)
        fts_regulation_id = g.app.get_value(omsg, ".//oub:fts.regulation.id", True)
        stopped_regulation_role = g.app.get_value(omsg, ".//oub:stopped.regulation.role", True)
        stopped_regulation_id = g.app.get_value(omsg, ".//oub:stopped.regulation.id", True)
