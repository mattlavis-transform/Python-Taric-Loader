...
class profile_37530_quota_closed_and_balance_transferred_event(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        closing_date = g.app.get_date_value(omsg, ".//oub:closing.date", True)
        transferred_amount = g.app.get_number_value(omsg, ".//oub:transferred.amount", True)
        target_quota_definition_sid = g.app.get_number_value(omsg, ".//oub:target.quota.definition.sid", True)
