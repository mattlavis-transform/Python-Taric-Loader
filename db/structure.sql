...
BEGIN
	...
	DELETE FROM public.import_files where import_file = my_import_file;

	DELETE FROM public.additional_code_description_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.additional_code_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.additional_code_type_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.additional_code_type_measure_types_oplog WHERE operation_date >= d;
	DELETE FROM public.additional_code_types_oplog WHERE operation_date >= d;
	DELETE FROM public.additional_codes_oplog WHERE operation_date >= d;
	DELETE FROM public.base_regulations_oplog WHERE operation_date >= d;
	DELETE FROM public.certificate_description_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.certificate_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.certificate_type_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.certificate_types_oplog WHERE operation_date >= d;
	DELETE FROM public.certificates_oplog WHERE operation_date >= d;
	DELETE FROM public.complete_abrogation_regulations_oplog WHERE operation_date >= d;
	DELETE FROM public.duty_expression_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.duty_expressions_oplog WHERE operation_date >= d;
	DELETE FROM public.export_refund_nomenclatures_oplog WHERE operation_date >= d;
	DELETE FROM public.export_refund_nomenclature_indents_oplog WHERE operation_date >= d;
	DELETE FROM public.export_refund_nomenclature_description_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.export_refund_nomenclature_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_association_erns_oplog WHERE operation_date >= d;
	DELETE FROM public.explicit_abrogation_regulations_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_association_additional_codes_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_association_goods_nomenclatures_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_association_measures_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_association_meursing_headings_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_description_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_type_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.footnote_types_oplog WHERE operation_date >= d;
	DELETE FROM public.footnotes_oplog WHERE operation_date >= d;
	DELETE FROM public.fts_regulation_actions_oplog WHERE operation_date >= d;
	DELETE FROM public.full_temporary_stop_regulations_oplog WHERE operation_date >= d;
	DELETE FROM public.geographical_area_description_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.geographical_area_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.geographical_area_memberships_oplog WHERE operation_date >= d;
	DELETE FROM public.geographical_areas_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclature_description_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclature_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclature_group_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclature_indents_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclature_origins_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclature_successors_oplog WHERE operation_date >= d;
	DELETE FROM public.goods_nomenclatures_oplog WHERE operation_date >= d;
	DELETE FROM public.languages_oplog WHERE operation_date >= d;
	DELETE FROM public.language_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_action_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_actions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_components_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_condition_code_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_condition_codes_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_condition_components_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_conditions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_excluded_geographical_areas_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_partial_temporary_stops_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_type_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_type_series_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_type_series_oplog WHERE operation_date >= d;
	DELETE FROM public.measure_types_oplog WHERE operation_date >= d;
	DELETE FROM public.measurement_unit_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measurement_unit_qualifier_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.measurement_unit_qualifiers_oplog WHERE operation_date >= d;
	DELETE FROM public.measurement_units_oplog WHERE operation_date >= d;
	DELETE FROM public.measurements_oplog WHERE operation_date >= d;
	DELETE FROM public.measures_oplog WHERE operation_date >= d;
	DELETE FROM public.meursing_additional_codes_oplog WHERE operation_date >= d;
	DELETE FROM public.meursing_heading_texts_oplog WHERE operation_date >= d;
	DELETE FROM public.meursing_headings_oplog WHERE operation_date >= d;
	DELETE FROM public.meursing_subheadings_oplog WHERE operation_date >= d;
	DELETE FROM public.meursing_table_cell_components_oplog WHERE operation_date >= d;
	DELETE FROM public.meursing_table_plans_oplog WHERE operation_date >= d;
	DELETE FROM public.modification_regulations_oplog WHERE operation_date >= d;
	DELETE FROM public.monetary_exchange_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.monetary_exchange_rates_oplog WHERE operation_date >= d;
	DELETE FROM public.monetary_unit_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.monetary_units_oplog WHERE operation_date >= d;
	DELETE FROM public.nomenclature_group_memberships_oplog WHERE operation_date >= d;
	DELETE FROM public.prorogation_regulation_actions_oplog WHERE operation_date >= d;
	DELETE FROM public.prorogation_regulations_oplog WHERE operation_date >= d;
	DELETE FROM public.publication_sigles_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_associations_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_balance_events_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_blocking_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_critical_events_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_definitions_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_exhaustion_events_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_order_number_origin_exclusions_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_order_number_origins_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_order_numbers_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_reopening_events_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_suspension_periods_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_unblocking_events_oplog WHERE operation_date >= d;
	DELETE FROM public.quota_unsuspension_events_oplog WHERE operation_date >= d;
	DELETE FROM public.regulation_replacements_oplog WHERE operation_date >= d;
	DELETE FROM public.regulation_role_types_oplog WHERE operation_date >= d;
	DELETE FROM public.regulation_role_type_descriptions_oplog WHERE operation_date >= d;
	DELETE FROM public.regulation_groups_oplog WHERE operation_date >= d;
	DELETE FROM public.regulation_group_descriptions_oplog WHERE operation_date >= d;
