...
class profile_37000_quota_definition(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        quota_order_number_id = g.app.get_value(omsg, ".//oub:quota.order.number.id", True)
        quota_order_number_sid = g.app.get_number_value(omsg, ".//oub:quota.order.number.sid", True)
        ...
        volume = g.app.get_value(omsg, ".//oub:volume", True)
        initial_volume = g.app.get_value(omsg, ".//oub:initial.volume", True)
        ...
        measurement_unit_qualifier_code = g.app.get_value(omsg, ".//oub:measurement.unit.qualifier.code", True)
        maximum_precision = g.app.get_value(omsg, ".//oub:maximum.precision", True)
        critical_state = g.app.get_value(omsg, ".//oub:critical.state", True)
        critical_threshold = g.app.get_value(omsg, ".//oub:critical.threshold", True)
