...
class profile_37510_quota_critical_event(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        occurrence_timestamp = g.app.get_date_value(omsg, ".//oub:occurrence.timestamp", True)
        critical_state = g.app.get_value(omsg, ".//oub:critical.state", True)
        critical_state_change_date = g.app.get_date_value(omsg, ".//oub:critical.state.change.date", True)
