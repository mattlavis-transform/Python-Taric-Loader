...
class profile_43025_measure_partial_temporary_stop(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        partial_temporary_stop_regulation_id = g.app.get_value(omsg, ".//oub:partial.temporary.stop.regulation.id", True)
        partial_temporary_stop_regulation_officialjournal_number = g.app.get_value(omsg, ".//oub:partial.temporary.stop.regulation.officialjournal.number", True)
        partial_temporary_stop_regulation_officialjournal_page = g.app.get_value(omsg, ".//oub:partial.temporary.stop.regulation.officialjournal.page", True)
        abrogation_regulation_id = g.app.get_value(omsg, ".//oub:abrogation.regulation.id", True)
        abrogation_regulation_officialjournal_number = g.app.get_value(omsg, ".//oub:abrogation.regulation.officialjournal.number", True)
        abrogation_regulation_officialjournal_page = g.app.get_value(omsg, ".//oub:abrogation.regulation.officialjournal.page", True)
