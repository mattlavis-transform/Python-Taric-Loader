...
class profile_28500_base_regulation(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        community_code = g.app.get_value(omsg, ".//oub:community.code", True)
        regulation_group_id = g.app.get_value(omsg, ".//oub:regulation.group.id", True)
        antidumping_regulation_role = g.app.get_value(omsg, ".//oub:antidumping.regulation.role", True)
        related_antidumping_regulation_id = g.app.get_value(omsg, ".//oub:related.antidumping.regulation.id", True)
