...
class profile_23500_measure_type(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        trade_movement_code = g.app.get_value(omsg, ".//oub:trade.movement.code", True)
        priority_code = g.app.get_value(omsg, ".//oub:priority.code", True)
        measure_component_applicable_code = g.app.get_value(omsg, ".//oub:measure.component.applicable.code", True)
        origin_dest_code = g.app.get_value(omsg, ".//oub:origin.dest.code", True)
        order_number_capture_code = g.app.get_value(omsg, ".//oub:order.number.capture.code", True)
        measure_explosion_level = g.app.get_value(omsg, ".//oub:measure.explosion.level", True)
