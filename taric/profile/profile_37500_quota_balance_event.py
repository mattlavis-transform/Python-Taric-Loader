...
class profile_37500_quota_balance_event(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        old_balance = g.app.get_value(omsg, ".//oub:old.balance", True)
        new_balance = g.app.get_value(omsg, ".//oub:new.balance", True)
        imported_amount = g.app.get_number_value(omsg, ".//oub:imported.amount", True)
        last_import_date_in_allocation = g.app.get_date_value(omsg, ".//oub:last.import.date.in.allocation", True)
