...
class profile_17000_publication_sigle(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        code_type_id = g.app.get_value(omsg, ".//oub:code.type.id", True)
        code = g.app.get_value(omsg, ".//oub:code", True)
        ...
        publication_code = g.app.get_value(omsg, ".//oub:publication.code", True)
        publication_sigle = g.app.get_value(omsg, ".//oub:publication.sigle", True)
