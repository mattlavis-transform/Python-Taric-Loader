...
class profile_30500_regulation_replacement(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        replacing_regulation_role = g.app.get_value(omsg, ".//oub:replacing.regulation.role", True)
        replacing_regulation_id = g.app.get_value(omsg, ".//oub:replacing.regulation.id", True)
        replaced_regulation_role = g.app.get_value(omsg, ".//oub:replaced.regulation.role", True)
        replaced_regulation_id = g.app.get_value(omsg, ".//oub:replaced.regulation.id", True)
        measure_type_id = g.app.get_value(omsg, ".//oub:measure.type.id", True)
        geographical_area_id = g.app.get_value(omsg, ".//oub:geographical.area.id", True)
        chapter_heading = g.app.get_value(omsg, ".//oub:chapter.heading", True)
