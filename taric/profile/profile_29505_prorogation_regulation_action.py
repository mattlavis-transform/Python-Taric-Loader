...
class profile_29505_prorogation_regulation_action(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        prorogation_regulation_role = g.app.get_value(omsg, ".//oub:prorogation.regulation.role", True)
        prorogation_regulation_id = g.app.get_value(omsg, ".//oub:prorogation.regulation.id", True)
        prorogated_regulation_role = g.app.get_value(omsg, ".//oub:prorogated.regulation.role", True)
        prorogated_regulation_id = g.app.get_value(omsg, ".//oub:prorogated.regulation.id", True)
        prorogated_date = g.app.get_date_value(omsg, ".//oub:prorogated.date", True)
