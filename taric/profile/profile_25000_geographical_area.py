...
class profile_25000_geographical_area(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        geographical_code = g.app.get_value(omsg, ".//oub:geographical.code", True)
        parent_geographical_area_group_sid = g.app.get_number_value(omsg, ".//oub:parent.geographical.area.group.sid", True)
