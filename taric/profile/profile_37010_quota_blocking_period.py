...
class profile_37010_quota_blocking_period(object):
    def import_node(self, app, update_type, omsg, transaction_id, message_id, record_code, sub_record_code):
        ...
        quota_blocking_period_sid = g.app.get_number_value(omsg, ".//oub:quota.blocking.period.sid", True)
        quota_definition_sid = g.app.get_number_value(omsg, ".//oub:quota.definition.sid", True)
        blocking_start_date = g.app.get_date_value(omsg, ".//oub:blocking.start.date", True)
        blocking_end_date = g.app.get_date_value(omsg, ".//oub:blocking.end.date", True)
        blocking_period_type = g.app.get_value(omsg, ".//oub:blocking.period.type", True)
