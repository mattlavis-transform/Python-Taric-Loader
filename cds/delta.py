...
from cds.delta_commodity import DeltaCommodity
from cds.delta_measure import DeltaMeasure
...
class Delta(object):
    ...
    def open_delta_file(self):
        folder = os.getcwd()
        folder = os.path.join(folder, "delta")
        commodities_file = os.path.join(folder, "commodities_{}.txt".format(self.to_date_string))
        measures_file = os.path.join(folder, "measures_{}.txt".format(self.to_date_string))
        self.delta_file_commodities = open(commodities_file, "w")
        self.delta_file_measures = open(measures_file, "w")
