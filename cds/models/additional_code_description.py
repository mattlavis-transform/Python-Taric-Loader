...
class AdditionalCodeDescription(Master):
    def __init__(self, elem, additional_code_description_period_sid, additional_code_sid, additional_code_type_id, additional_code, import_file, transform_only=False):
        ...
        g.app.print_only("Running operation {0} on additional code description {1}.".format(self.operation, self.additional_code_description_period_sid))
