...
class CertificateDescription(Master):
    def __init__(self, elem, certificate_description_period_sid, certificate_type_code, certificate_code, import_file, transform_only=False):
        ...
        g.app.print_only("Running operation {0} on certificate descrition {1}.".format(self.operation, str(self.certificate_description_period_sid)))
